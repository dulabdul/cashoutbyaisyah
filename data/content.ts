...
export const content = {
  nav: {
    home: "Utama", // Saya ubah jadi Bahasa Melayu standar
    about: "Tentang Kami",
    why: "Kenapa Kami",
    service: "Servis",
    advantage: "Kelebihan",
  ...
  about: {
    title: "Tentang Kami",
    badge: "Profesional & Terpercaya",
    desc: "Perkhidmatan Pencairan Wang dari Platform PayLater dengan Mudah dan Cepat bersama Cashout SPayLater! Adakah anda mencari cara yang mudah dan cepat untuk mendapatkan wang tunai daripada had SPayLater atau Boost PayLater anda? Cashout SPayLater adalah penyelesaian terbaik untuk anda!"
  },
  why: {
    title: "Kenapa Pilih Kami",
    desc: "Memilih perkhidmatan kami bermaksud anda mengutamakan kepantasan, keselamatan dan kemudahan. Kami memahami bahawa keperluan dana yang mendesak tidak boleh ditangguhkan.",
    cta: "Hubungi Kami"
  },
  services: {
    title: "KHIDMAT KAMI",
  ...
  whatsapp: {
    message: "Halo, saya berminat untuk cashout PayLater."
  }
};